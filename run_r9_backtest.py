#!/usr/bin/env python3
"""
Run R9 Volume Profile Backtest
"""
...
spec = importlib.util.spec_from_file_location("VolumeProfileBacktest", "backtest_modules/4_hour_backtest_modules/volume_profile_backtest_4h_r9.py")
...
def main():
    print("🚀 Starting R9 Volume Profile Backtest...")
    ...
    # Run backtest
    print("📊 Running R9 backtest...")
    results = backtest.run_simple_backtest()
    
    print("✅ R9 backtest completed!")
    print(f"📈 Results saved to: {output_path}")
    
    # Print summary
    if results:
        print("\n📊 R9 Performance Summary:")
