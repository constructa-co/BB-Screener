...
class ElliottWaveScanner:
    ...
    def get_symbols(self):
        ...
        try:
            ...
            # Focus on major cryptocurrencies with clear trends
            major_symbols = [
            ...
            return final_symbols[:20]  # Focus on top 20 major coins
    ...
    def calculate_bearish_targets(self, waves, current_price):
        """Calculate realistic bearish Elliott Wave targets"""
        try:
            if len(waves) >= 4:
            ...
            return [current_price * 0.9, current_price * 0.8, current_price * 0.7]
    ...
    def scan_all_symbols(self):
        """Scan all symbols for current Elliott Wave structures"""
    ...
    def display_bearish_wave_cycle(self, pattern, waves, current_price):
        ...
        if len(waves) >= 3:
            ...
            estimated_wave4_end = wave4_normal if 'wave4_normal' in locals() else wave3_end * 1.15
            wave5_t1 = estimated_wave4_end - (wave1_size * 0.618)
            wave5_t2 = estimated_wave4_end - wave1_size
            wave5_t3 = estimated_wave4_end - (wave1_size * 1.618)
            
            print(f"\n   📉 ULTIMATE WAVE 5 DOWNSIDE TARGETS:")
            print(f"   W5-T1: ${wave5_t1:.2f} (61.8%) | W5-T2: ${wave5_t2:.2f} (100%) | W5-T3: ${wave5_t3:.2f} (161.8%)")
        ...
        if current_wave == 'WAVE_2':
            ...
            print(f"      • TARGET: Wave 3 decline ${wave5_t1:.2f} - ${wave5_t2:.2f}")
            print(f"      • R:R: Excellent (Wave 3 strongest decline)")
            
        elif current_wave == 'WAVE_3':
            if current_price <= waves[2]['start']['price'] if len(waves) >= 3 else True:
                ...
                print(f"   📊 CURRENT STATUS: Above Wave 3 - likely Wave 4 bounce")
                ...
                print(f"      • TARGET: Wave 5 decline ${wave5_t1:.2f} - ${wave5_t2:.2f}")
            ...
            print(f"   🎯 TARGETS: Wave 5 decline ${wave5_t1:.2f} - ${wave5_t2:.2f}")
