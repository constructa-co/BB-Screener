...
class WeeklyElliottWaveScanner:
    ...
    def scan_all_symbols(self):
        ...
        if self.elliott_logger and all_patterns:
            try:
                scan_id = f"elliott_weekly_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
                ...
                for pattern in all_patterns:
                    ...
                    signal_data = {
                        ...
                        'current_wave': pattern['current_wave'],
                        'wave_degree': 'major',  # Weekly timeframe = major degree
                        'pattern_quality': pattern['quality_score'],
                        'confidence_score': pattern.get('confidence', 0.8),  # Higher confidence for weekly
